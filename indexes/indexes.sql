...
CREATE INDEX IF NOT EXISTS idx_destinatario_id_destinatario ON destinatario (id_destinatario ) ;
...
CREATE INDEX IF NOT EXISTS idx_responsavel_disciplina_id_professor ON responsavel_disciplina ( id_professor ) ;

-- 7) Índice para Histórico de Avisos por Funcionário
CREATE INDEX IF NOT EXISTS idx_aviso_id_funcionario ON aviso ( id_funcionario_administrativo ) ;
